      ...
      <Box>
                ...
                <Stack spacing={2}>
                  ...
                  <Box sx={{ pt: 1, display: 'flex', gap: 1.5 }}>
                    <Button
                      ...
                      disabled={loading} fullWidth sx={{ borderRadius: theme.shape.borderRadius * 5 }}
                    >
                      {editingId ? 'Update Pizza' : 'Add Pizza'}
                    </Button>
                    {editingId && (
                      <Button
                        variant="containedTonal" color="primary" onClick={handleCancelEdit}
                        startIcon={<CloseIcon />} disabled={loading} fullWidth
                        ...
                        <TableRow key={item.id} hover sx={{
                          ...
                          <TableCell align="right">
                            <Tooltip title="Order pizza">
                              <span>
                                <IconButton
                                  color="success" onClick={() => handleOrder(item)} size="small" aria-label="order pizza"
                                  sx={{ mr: 1, '&:hover': { backgroundColor: alpha(theme.palette.success.main, 0.08) } }}
                                >
                            ...
                            <Tooltip title="Edit pizza details">
                              <span>
                                <IconButton
                                  color="primary" onClick={() => handleEdit(item)} size="small" aria-label="edit pizza details"
                                  disabled={loading}
                            ...
                            <Tooltip title="Delete pizza">
                              <span>
                                <IconButton
                                  color="error" onClick={() => handleDeleteConfirm(item.id)} size="small" aria-label="delete pizza"
                                  disabled={loading}
                                  sx={{ '&:hover': { backgroundColor: alpha(theme.palette.error.main, 0.08) } }}
                                >
        ...
        >
          ...
          <DialogActions sx={{ p: 2 }}>
            ...
            <Button onClick={confirmDelete} color="error" variant="contained" disableElevation autoFocus sx={{ borderRadius: theme.shape.borderRadius * 5 }}>
              Delete
            </Button>
          </DialogActions>
        </Dialog>
