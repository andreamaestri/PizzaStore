...
import { Receipt as OrdersIcon, People as CustomersIcon, LocalPizza as PizzaIcon } from "@mui/icons-material";
...
const Home = () => {
  ...
  return (
    <PageContainer sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
      <Box
        sx={{
          maxWidth: 1200,
          mx: "auto",
