...
const Orders = () => {
	...
	const handleRowClick = useCallback(
		...
		[navigate],
	); // Dependency on the navigate function.
	...
	return (
		...
		<PageContainer sx={{ display: "flex", flexDirection: "column", p: 0 }}>
			...
			>
				...
				>
					...
					<Box>
						...
						>
							View and manage all customer orders. Use the search to filter by
